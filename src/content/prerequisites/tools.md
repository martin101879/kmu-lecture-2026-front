...
AWS 서비스를 터미널에서 제어하는 도구입니다. S3 업로드, ECR 로그인, ECS 배포 등에 사용합니다.
...
또는 [https://awscli.amazonaws.com/AWSCLIV2.pkg](https://awscli.amazonaws.com/AWSCLIV2.pkg) 에서 설치 파일을 다운로드합니다.
...
> 초기 설정(`aws configure`)은 강의 중에 진행합니다. 사전에는 설치만 해주세요.
